...
class DualSegmentation(nn.Module):
    """Predict a semantic class for every face in a B-rep solid."""
    ...
    def __init__(
        ...
        self.head = PredictionHead(
            input_dim=args.graph_emb_dim + args.surface_emb_dim,
