...
def build_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Dataset directory containing datasplit.json",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=8,
        help="Workers for eager dataset loading",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Face UV samples per dimension; must match --u_samples",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Checkpoint to resume trainer state",
    )
...
def _validate_sampling_args(args):
    if args.u_samples != args.v_samples:
        raise ValueError("The processed dataset uses square UV grids, so --u_samples and --v_samples must be equal")
...
def main():
    ...
    if args.traintest == "train":
        print_run_banner(
            "Brep2Shape Self-Supervised Pretraining",
